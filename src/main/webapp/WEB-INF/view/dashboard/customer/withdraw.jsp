	...
	<div id=homemaindiv>
		...
		<div id="homediv">
			...
			<div id=moneydiv>
				<br> <br>
				<div>
					<form action="${pageContext.request.contextPath}/rewith"
						method="post">
						<label>Enter Withdraw Amount</label><br>
						<p style="color:#E55039">${amerror}</p>
						<input type="text" name="withamount"
							placeholder="Enter the amount" /> <br> <br>
